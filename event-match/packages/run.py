...
from packages.ingest import load_csv, summarize as summarize_people
from packages.schema import EnrichedPerson, Person
from packages.rubric import synthesize_rubric
from packages.enrich import enrich_batch
from packages.matrix import compute_matrix, save_matrix
...
async def run_pipeline(
    ...
    *,
    ...
    if enrich_model:
        ...
        import packages.enrich as _enrich
